...
/**
 * Every category and style from the 2021 BJCP beer style guidelines.
 *
 * Also available as the default export, and as raw JSON via the
 * `beer-styles/2021/styles.json` subpath.
 */
export const beerStyles: BeerStyles = styleData as BeerStyles;

/** The guideline year this module represents. */
export const year = 2021 as const;
